...
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=oapserverdynamicconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=oapserverdynamicconfigs/status,verbs=get;update;patch
