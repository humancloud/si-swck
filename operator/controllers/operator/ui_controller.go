...
import (
	...
	uiv1alpha1 "github.com/apache/stackinsights-swck/operator/apis/operator/v1alpha1"
...
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=uis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=uis/status,verbs=get;update;patch
