...
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=oapservers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=oapservers/status,verbs=get;update;patch
...
func (r *OAPServerReconciler) ConfigStorage(ctx context.Context, log logr.Logger, s *operatorv1alpha1.Storage, o *operatorv1alpha1.OAPServer) {
	...
	SwStorageEsSslJksPass := "stackinsights"
	...
	if tls {
		...
		SwStorageEsSslJksPath = "/stackinsights/p12/storage.p12"
		SwStorageEsClusterNodes = "stackinsights-storage"
	} else {
