...
import (
	...
	"github.com/apache/stackinsights-swck/operator/pkg/operator/injector"
)
...
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=javaagents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=javaagents/status,verbs=get;update;patch;delete
