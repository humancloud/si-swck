...
//+kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=banyandbs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=banyandbs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=operator.stackinsights.apache.org,resources=banyandbs/finalizers,verbs=update
