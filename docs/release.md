# Apache StackInsights Cloud on Kubernetes release guide
...
1. Close(if finished, or move to next milestone otherwise) all issues in the current milestone from [stackinsights-swck](https://github.com/humancloud/si-swck/milestones) and [stackinsights](https://github.com/apache/stackinsights/milestones), create a new milestone if needed.
 ...
 * https://github.com/humancloud/si-swck/blob/$VERSION/CHANGES.md
 ...
 * https://github.com/humancloud/si-swck/tree/<Git Commit Hash>
 ...
 * https://github.com/humancloud/si-swck/blob/$VERSION/docs/operator.md#build-from-sources
 * https://github.com/humancloud/si-swck/blob/$VERSION/docs/custom-metrics-adapter.md#use-kustomize-to-customise-your-deployment
 * https://github.com/humancloud/si-swck/blob/$VERSION/docs/release.md
...
1. Refer to the previous [PR](https://github.com/apache/stackinsights-website/pull/508), update news and links on the website. There are seven files need to modify.

1. Update [Github release page](https://github.com/humancloud/si-swck/releases), follow the previous convention.
...
1. Send ANNOUNCE email to `dev@stackinsights.apache.org` and `announce@apache.org`, the sender should use his/her Apache email account. You can get the permlink of vote thread at [here](https://lists.apache.org/list.html?dev@stackinsights.apache.org).
    ...
    Release Notes : https://github.com/humancloud/si-swck/blob/$VERSION/CHANGES.md
    ...
    - Documents: https://github.com/humancloud/si-swck/blob/$VERSION/README.md
